...
def convert_meters_to_pixel_distance(meters, refernce_height_meters, reference_height_in_pixels):
    
    return (meters * reference_height_in_pixels) / refernce_height_meters
